...
EXECUTION_PROMPT = (
    ...
    "split travel into arbitrary waypoint walks; call walk_to for the actual "
    "target, and only choose a new nearby target when a movement tool reports "
    "blocked or timed out. After you place or change production, call "
    "verify_production and fix what is broken. "
...
STALE_MANUAL_AUTOMATION_ADVISORY = (
    ...
    "execute_edge_miner, build_assembler_feed, plan_machine_output then build_assembler_output for machine/furnace output belts, or build_lab_feed as "
