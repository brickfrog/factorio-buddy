...
local function can_place(surface, force, entity_name, position, direction)
    ...
    return policy.policy_allowed == true, policy.error, {
        ...
        overlapping_resource_tiles = policy.overlapping_resource_tiles,
        overlapping_resource_amount = policy.overlapping_resource_amount,
        resource_overlap = policy.resource_overlap,
        resource_overlap_tile_count = policy.resource_overlap_tile_count,
        resource_advisory = policy.advisory,
...
local function checked_entity(surface, force, entity_name, position, direction)
    ...
    return {
        ...
        overlapping_resource_tiles = report.overlapping_resource_tiles,
        overlapping_resource_amount = report.overlapping_resource_amount,
        resource_overlap = report.resource_overlap,
        resource_overlap_tile_count = report.resource_overlap_tile_count,
        resource_advisory = report.resource_advisory,
